...
function level_customize_register( $wp_customize ) {
   ...
   class level_Important_Links extends WP_Customize_Control {
      ...
      public function render_content() {
		 ...
		 echo '<ul><b>
			<li>' . esc_attr__( '* Fully Mobile Responsive', 'level' ) . '</li>
			<li>' . esc_attr__( '* Dedicated Option Panel', 'level' ) . '</li>
			<li>' . esc_attr__( '* Customize Theme Color', 'level' ) . '</li>
			<li>' . esc_attr__( '* WooCommerce & bbPress Support', 'level' ) . '</li>
			<li>' . esc_attr__( '* SEO Optimized', 'level' ) . '</li>
			<li>' . esc_attr__( '* Control Individual Meta Option like: Category, date, Author, Tags etc. ', 'level' ) . '</li>
         ...
         $important_links = array(
            'theme-info' => array(
               'link' => esc_url('https://www.insertcart.com/product/level-wordpress-theme/'),
